...
#include "/home/acastro/Energia/libraries/Watchdog/WatchdogMan.h"
#include <lwip/dns.h>

/* Set connection timeout to 10 sec */ //Now changing the millis function inside EthernetClient to micros, will set the default connection timeout to 10 ms
